...
#define TOPICO_SUBSCRIBE    "/TEF/insu240/cmd"        //tópico MQTT de escuta
#define TOPICO_PUBLISH      "/TEF/insu240/attrs/c"      //tópico MQTT de envio de informações para Broker
#define TOPICO_PUBLISH_2    "/TEF/insu240/attrs/c"    //tópico MQTT de envio de informações para Broker
                                                      //IMPORTANTE: recomendamos fortemente alterar os nomes
                                                      //            desses tópicos. Caso contrário, há grandes
                                                      //            chances de você controlar e monitorar o ESP32
                                                      //            de outra pessoa.
#define ID_MQTT  "fiware_insu240"      //id mqtt (para identificação de sessão)
...
// variavel de salvamento dos valores do potenciometro
float potE; 
bool insulina;
...
void loop() 
{   
  char msgBuffer[7];  // Ajustei o tamanho do buffer para acomodar números inteiros maiores
  potE = analogRead(34);
  lcd.clear();
  apagaLeds();
  ...
  lcd.clear();
  reconnectMQTT();
  // Convertendo o valor do potenciômetro para string
  dtostrf(insulina, 7, 2, msgBuffer);
